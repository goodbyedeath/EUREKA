    ...
    <section class="relative pt-16 overflow-hidden">
        <div class="relative h-screen">
            ...
            <div id="hero-carousel" class="relative h-full">
                        ...
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            <div class="max-w-4xl mx-auto">
                                ...
                                <p class="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
                                    Discover knowledge through engaging quizzes, track your progress, and compete with teams in a gamified learning environment.
                                </p>
                ...
                <!-- Slide 2 -->
                <div class="carousel-slide absolute inset-0 bg-gradient-to-br from-green-500 via-teal-500 to-blue-600">
                    <div class="flex items-center justify-center h-full">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            <div class="max-w-4xl mx-auto">
                                <h1 class="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                                    QR Code Powered Quests
                                </h1>
                                <p class="text-xl md:text-2xl text-green-100 mb-8 leading-relaxed">
                                    Scan QR codes to unlock exciting questionnaires and challenges. Learn by exploring your environment and discovering hidden knowledge.
                                </p>
                                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                    <a href="{{ route('register') }}" class="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg text-green-600 bg-white hover:bg-gray-50 transition duration-300 shadow-lg">
                                        Explore Quests
                                        <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Slide 3 -->
                <div class="carousel-slide absolute inset-0 bg-gradient-to-br from-purple-600 via-pink-500 to-red-500">
                    <div class="flex items-center justify-center h-full">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            <div class="max-w-4xl mx-auto">
                                <h1 class="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                                ...
                                <p class="text-xl md:text-2xl text-purple-100 mb-8 leading-relaxed">
                                    Join teams, track your learning progress, and compete with others. Comprehensive analytics help you understand your growth journey.
                                </p>
                                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                    <a href="{{ route('register') }}" class="inline-flex items-center px-8 py-4 border border-transparent text-lg font-medium rounded-lg text-purple-600 bg-white hover:bg-gray-50 transition duration-300 shadow-lg">
                                        Join Community
                                        <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-3">
                <button class="carousel-indicator w-3 h-3 rounded-full bg-white bg-opacity-50 hover:bg-opacity-100 transition duration-300" data-slide="0"></button>
                <button class="carousel-indicator w-3 h-3 rounded-full bg-white bg-opacity-50 hover:bg-opacity-100 transition duration-300" data-slide="1"></button>
                <button class="carousel-indicator w-3 h-3 rounded-full bg-white bg-opacity-50 hover:bg-opacity-100 transition duration-300" data-slide="2"></button>
            </div>
        </div>
    </section>
